...
{
class CartesianImpedanceSimController : public controller_interface::MultiInterfaceController<
...
private:
  ...
  void DesiredGainsParamCallback(smalldrop_robot_arm::CartesianImpedanceSimControllerConfig &config,
                                 uint32_t level);
