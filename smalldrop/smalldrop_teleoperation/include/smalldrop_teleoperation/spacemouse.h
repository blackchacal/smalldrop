...
private:
  ...
  smalldrop_bioprint::SystemState* system_state_;
...
public:
  /**
   * \fn SpaceMouse(std::string topic, smalldrop_bioprint::SystemState* system_state)
   ...
   */
  SpaceMouse(std::string topic, smalldrop_bioprint::SystemState* system_state);

  /**
   * \fn SpaceMouse(std::string topic, std::list<IRemoteControllerMode *> modes, smalldrop_bioprint::SystemState* system_state)
   ...
   * \param system_state SystemState class pointer. It provides access to all the system data.
   */
  SpaceMouse(std::string topic, std::list<IRemoteControllerMode *> modes, smalldrop_bioprint::SystemState* system_state);
