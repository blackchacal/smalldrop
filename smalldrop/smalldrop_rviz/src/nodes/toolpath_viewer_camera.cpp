...
sensor_msgs::ImagePtr getImageForPublication(WSegmentCamBinary &wseg, const Eigen::Matrix4d& transform, img_wsp_calibration_t calibration_data);
...
int main( int argc, char** argv )
{
  ...
  while (ros::ok())
  {
    ...
    sensor_msgs::ImagePtr msg = getImageForPublication(wseg, transform, calibration_data);
    pub.publish(msg);
