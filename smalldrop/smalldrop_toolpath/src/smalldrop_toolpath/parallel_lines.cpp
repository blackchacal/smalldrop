...
/**
 * \copybrief ParallelLines::ParallelLines(const points_t contour, const unsigned int offset, const IMAGE_AXIS axis, const double
 pose_z, const img_wsp_calibration_t calibration_data)
 */
ParallelLines::ParallelLines(const points_t contour, const unsigned int offset, const IMAGE_AXIS axis, const double pose_z,
