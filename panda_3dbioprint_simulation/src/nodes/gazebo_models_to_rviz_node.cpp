...
std::string rviz_markers_topic = "/panda_3dbioprint_simulation/gazebo_rviz_markers";
...
void gazeboModelStatesCallback(const gazebo_msgs::ModelStatesConstPtr msg)
{
  ...
  for (size_t i = 0; i < size; i++)
  {
      ...
      msg->name[i].compare("tv") != 0)
    {
      ...
      marker.color.a = 1.0;
      marker.mesh_resource = "package://panda_3dbioprint_simulation/models/"+msg->name[i]+"/meshes/"+msg->name[i]+".dae";
