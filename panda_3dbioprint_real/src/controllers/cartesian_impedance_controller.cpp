...
bool CartesianImpedanceController::init(hardware_interface::RobotHW *robot_hw, ros::NodeHandle &nh)
{
  ...
  tauPub = nh.advertise<panda_3dbioprint_simulation::Tau>("/cartesian_impedance_controller/tau", 10);
  wrenchPub = nh.advertise<geometry_msgs::Wrench>("/cartesian_impedance_controller/wrench", 10);
  errorPub = nh.advertise<panda_3dbioprint_simulation::TrackingError>("/cartesian_impedance_controller/error", 10);
  controlSrv = nh.advertiseService("send_torques_to_robot", &CartesianImpedanceController::sendTorquesToRobot, this);
